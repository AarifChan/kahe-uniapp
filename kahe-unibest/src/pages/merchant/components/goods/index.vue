<template>
  <view class="merchantGoods">
    ...
    <view v-if="item.productNum === 0" class="merchantGoods-empty">
    ...
    <view class="merchantGoods-info">
      <view class="merchantGoods-info-content">
        <view class="merchantGoods-info-content-bottom">
          <view class="merchantGoods-info-content-bottom-title text-flow-ellipsis-single">
            {{ item.title }}
          </view>
          <view class="merchantGoods-info-content-bottom-row1">
            <image
              class="merchantGoods-info-content-bottom-row1-bg"
    ...
    <image v-if="showTag" class="merchantGoods-tags" :src="getMainTagImagePath(Number(item.mainTag))" />
  </view>
</template>
