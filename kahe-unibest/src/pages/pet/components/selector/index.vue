<template>
  <view class="customSelector">
    ...
    <!--        </view> -->
    <view v-if="dropDown" class="customSelector-dropdown">
...
function clickOption(op: OptionsModel) {
...
.customSelector {
  ...
  &-dropdown {
    ...
    background: #3a3a3a;
    box-shadow:
      2rpx 3rpx 3rpx 0rpx #448483,
      0rpx -1rpx 1rpx 0rpx rgba(0, 0, 0, 0.45),
      0rpx 1rpx 1rpx 0rpx rgba(179, 197, 219, 0.45);
    border-radius: 10rpx;
    text-align: center;
    font-weight: 400;
    font-size: 24rpx;
