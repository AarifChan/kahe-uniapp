    ...
    <view class="shipment">
      <view class="shipment-content">
        <view class="shipment-content-top">
          <view class="shipment-content-top-title theme-font text-stroke-main">
            发货确认
          </view>
          <view class="shipment-content-top-closeBg">
            <image class="shipment-content-top-closeBg-close" src="https://jms.85gui7.com/kahe/common/close-white.png" @tap.stop="emits('update:show', false)" />
          </view>
        </view>
        <view v-if="address?.price ?? false" class="shipment-content-info">
        ...
        <view class="shipment-content-center">
          <scroll-view class="shipment-content-center-scroll" :scroll-x="true" :enable-flex="true" scroll-with-animation>
            <view class="shipment-content-center-scroll-content">
              <view v-for="(item, index) in list" :key="index" class="shipment-content-center-scroll-content-item">
...
import type { AddressModel, SubmitGoodsModel } from '@/model'
