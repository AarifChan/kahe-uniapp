<template>
  ...
  >
    <view class="cardShow">
      ...
      />
      <view class="cardShow-title theme-font">
        {{ title }}
      </view>
      <scroll-view
      ...
      >
        <!-- 规则 -->
        <view v-if="current === 1" class="cardShow-center-context">
...
import type { UIProductBoxModel, UIProductDetailLevelGroup, UIProductDetailLevelList, UIProductRecordModel } from '@/model'
...
function sortTabAction(item: any) {
