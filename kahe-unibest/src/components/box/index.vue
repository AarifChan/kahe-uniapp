  ...
  <view class="goodsBox">
    <view class="goodsBox-decorate">
      ...
      <view class="goodsBox-decorate-content">
        ...
        <text v-if="nums" class="goodsBox-decorate-content-text">
          x{{ item.total }}
        </text>
        <text v-if="info" class="goodsBox-decorate-content-num">
    ...
    <view v-if="info" class="goodsBox-info">
      ...
      <view class="goodsBox-info-subTitle">
        水晶: <text style="color: red">{{ item.price }}</text>
      </view>
    </view>
    <view v-else class="goodsBox-info">
      <view class="goodsBox-info-title text-flow-ellipsis-single">
        {{
          item.title
        }}
