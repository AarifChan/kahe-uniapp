<template>
  <view class="goodsInfo">
    <view v-if="item.productNum === 0" class="goodsInfo-empty">
    ...
    <view class="goodsInfo-info">
      <view class="goodsInfo-info-content">
        <view class="goodsInfo-info-content-bottom">
          <view class="goodsInfo-info-content-bottom-title text-flow-ellipsis-multiple">
            {{ item.name }}
          </view>
          <view class="goodsInfo-info-content-bottom-row1">
            <text class="goodsInfo-info-content-bottom-row1-title price-font">
              {{ isFromMall ? '' : '' }}{{
                item.price }}/{{
                isFromMall ? '点券' : '抽'
              }}
    ...
    <image v-if="showTag" class="goodsInfo-tags" :src="item.mainTagImage" />
  </view>
</template>
