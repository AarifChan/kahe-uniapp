<template>
  <view class="common-tab">
    <view class="common-tab-list">
      <view v-for="(item, index) in list" :key="index" class="common-tab-list-item" @tap.stop="clickItem(index)">
        <view :class="index === current ? 'common-tab-list-item-select' : 'common-tab-list-item-content'">
          <image v-if="current === index" class="common-tab-list-item-content-select" src="https://jms.85gui7.com/kahe-202510/home/home-tab.png" />
