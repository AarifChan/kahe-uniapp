  ...
  <view class="payItem">
    ...
    >
      ...
      <view class="payItem-content-info">
        <view class="payItem-content-info-title">
          {{ goods.goodsDto?.name }}
        </view>
        <view class="payItem-content-info-bottom">
          <view class="payItem-content-info-bottom-price" />
          <view class="payItem-content-info-bottom-num">
            X{{ goods.num }}
          </view>
        </view>
      </view>
    ...
    <view class="payItem-bottom theme-font">
      <view class="payItem-bottom-title">
        共
      </view>
      <view class="payItem-bottom-value">
        {{ item.num }}
      </view>
      <view class="payItem-bottom-title">
        件
      ...
      <view class="payItem-bottom-value">
        ¥{{ item.price + item.ticket + item.coin }}
      </view>
    </view>
  </view>
</template>
...
import type { ProductGoodsModel, ProductOrderModel } from '@/model'
...
const goodsList = computed(() => {
  const tmpList = props.item?.goods ?? []
