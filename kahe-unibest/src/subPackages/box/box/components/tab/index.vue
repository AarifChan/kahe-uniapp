<template>
  <view class="home-tab">
    <view class="home-tab-list">
      <view v-for="(item, index) in list" :key="index" class="home-tab-list-item" @tap.stop="clickItem(index)">
        <view v-if="current === index" class="home-tab-list-item-select">
          <!-- <image
            class="home-tab-list-item-select-img"
            src="https://jms.85gui7.com/kahe-202510/ka-he/home/tab-bg.png"
          /> -->
          <view class="home-tab-list-item-select-title theme-font">
            {{ item.title }}
          </view>
        </view>
        <view v-else class="home-tab-list-item-normal">
          {{ item.title }}
        </view>
      </view>
    </view>
