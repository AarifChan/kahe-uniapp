<template>
  <view class="container">
    <view class="mallTab">
      <text
        class="mallTab-item price-font" :class="current === 0 ? 'mallTab-active' : ''"
        @tap.stop="didClick(0)"
      >
        最新
      </text>
      <text
        class="mallTab-item price-font" :class="current === 1 ? 'mallTab-active' : ''"
        @tap.stop="didClick(1)"
      >
        进度
      </text>
      <text
        class="mallTab-item price-font" :class="current === 2 ? 'mallTab-active' : ''"
        @tap.stop="didClick(2)"
      >
        价格
      </text>
