<template>
  <view class="commonTab">
    <image
      class="commonTab-bg" :src="currentIndex === 0
    ...
    <view class="commonTab-tab" style="left: 46rpx" @tap.stop="tabDidChange(0)">
      ...
      <view class="commonTab-tab-title theme-font" :style="{ opacity: currentIndex === 0 ? 1 : 0.6 }">
        赏池
      </view>
    </view>
    <view class="commonTab-tab" style="left: 192rpx" @tap.stop="tabDidChange(1)">
      <view v-if="currentIndex === 1" class="commonTab-tab-active" />
      <view class="commonTab-tab-title theme-font" :style="{ opacity: currentIndex === 1 ? 1 : 0.6 }">
        记录
      </view>
    </view>
    ...
    <scroll-view
      v-if="currentIndex === 0" :scroll-y="true" class="commonTab-goods"
