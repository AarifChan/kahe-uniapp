  ...
  <view class="normalBottom">
    ...
    <view class="normalBottom-info">
      ...
      <view class="normalBottom-info-center">
        <view v-for="(item, index) in cardsArray" :key="`card-index${index}`" class="normalBottom-info-center-item" @tap.stop="didSelectCard(item)">
...
function handleChangeNum(isLeft: boolean) {
...
function didSelectCard(item: UIProductPriceCard) {
