    ...
    <view class="king">
      ...
      <view class="king-left">
        <view class="king-left-content">
          ...
          <image
            v-if="product.demonKing.exist" class="king-left-content-avatar"
      ...
      <view v-if="product.demonKing.exist" class="king-info">
        <view class="king-info-title theme-font">
          {{
            product.demonKing.nickname
          }}
        </view>
        <view class="king-info-subTitle">
          已累计获得{{ product.demonKing.coin }}
        </view>
      </view>
      <view v-else class="king-info">
        <view class="king-info-title theme-font">
          暂无魔王
        </view>
        <view class="king-info-subTitle">
