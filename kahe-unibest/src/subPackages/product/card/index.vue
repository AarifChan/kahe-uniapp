<template>
  <view calss="cards">
    ...
    <Lamp ref="barrageRef" :list="barrageList" @tap-lamp-action="tapLampAction" />
    <view class="cards-mains">
      ...
      <Rightmo :list="itemList" @tap-item="tapItem" />
    </view>
    ...
    <bottoms :list="cardsList" :product-detail="productDetail" @tap-cards="didTapPurchaseNum" />
    <pay
      v-model:show="payShow" v-model:skip-checked="skipLottery" :goods="payItem" :merchant="productDetail.merchant"
      :show-skip="true" @did-tap-pay="didTapPay" @did-tap-coupon="didTapCoupon"
    />
    <reward
      v-model:show="rewardShow" :reward-list="rewardList" :types="false" :is-card="true" :nums="true"
      @did-click-smash="didTapSmashRightNow"
    />
    <smash v-model:show="smashShow" :recycle-goods="recycleGoods" @did-tap-smash="handleSmashGoods" />
    <card-show
      v-model:show="cardShow" :title="changeTitle[currentValue]" :current="currentValue"
      :sort-list="sortList" :record-list="recordList" :level-group-list="levelGroupList"
      :goods-list="goodsList" :level-list="levelList" @sort-tab-action="sortTabAction"
