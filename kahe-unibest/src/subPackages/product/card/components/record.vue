<template>
  <view v-if="recordList.length > 0" class="record">
    <view v-if="!types" class="record-level">
      <view
        v-for="(item, index) in list" :key="index" class="record-level-item" :class="sortIndex === item.value ? 'active' : ''"
    ...
    <view v-for="(item, index) in recordList" :key="index" class="record-listItem">
      <view v-if="types && !isOpen" class="record-listItem-num">
        #{{ item.sales }}
      </view>
      <view class="record-listItem-list">
        ...
        <view class="record-listItem-list-time">
          {{ item.time }}
        </view>
      </view>
      ...
      <view class="record-listItem-bottom">
        <view class="record-listItem-bottom-left">
          ...
          <view class="record-listItem-bottom-left-name">
            {{ item.title }}{{ isOpen ? `x${item.num}` : "" }}
          </view>
        </view>
