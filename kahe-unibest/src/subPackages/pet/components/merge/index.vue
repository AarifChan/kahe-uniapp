<template>
  <view class="mergeTop">
    ...
    <view v-if="left" class="mergeTop-icon leftSide" @tap.stop="emits('update:left', null)">
    ...
    <view v-if="right" class="mergeTop-icon rightSide" @tap.stop="emits('update:right', null)">
    ...
    <custom-pet-btn v-if="left && right" class="mergeTop-action theme-font" title="融合" @tap.stop="emits('didClickMerge')" />
  </view>
</template>
