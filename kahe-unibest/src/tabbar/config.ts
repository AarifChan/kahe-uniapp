...
export const customTabbarList: CustomTabBarItem[] = [
  {
    ...
    iconType: 'image',
    icon: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item1.png',
    iconActive: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item1-active.png',
  },
  {
    text: '商家',
    pagePath: 'pages/merchant/index',
    iconType: 'image',
    icon: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item2.png',
    iconActive: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item2-active.png',
  },
  {
    text: '抽卡机',
    pagePath: 'pages/machine/index',
    iconType: 'image',
    icon: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item3-active.png',
    iconActive: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item3-active.png',
  },
  {
    text: '盒柜',
    pagePath: 'pages/box/index',
    iconType: 'image',
    icon: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item4.png',
    iconActive: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item4-active.png',
  },
  {
    text: '我的',
    pagePath: 'pages/mine/index',
    iconType: 'image',
    icon: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item5.png',
    iconActive: 'https://jms.85gui7.com/kahe-202510/ka-he/tab-bar/item5-active.png',
  },
]
