...
export function useBox() {
  ...
  const didTapConfirm = async (num: number) => {
    ...
    if (resp.code === 200) {
      ...
      const chestList: UIProductOpenBoxModel[] = new Array<UIProductOpenBoxModel>()
      const smashList: UIMineProductBoxModel[] = new Array<UIMineProductBoxModel>()
