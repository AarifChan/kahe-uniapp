    ...
    <view class="relative w-750 h-screen flex flex-col">
      <view class="relative w-750">
        ...
        <view class="absolute top-16 left-16 flex flex-row">
          ...
          <view
            class="font-normal text-20 text-white py-6"
            style="border-bottom: 1rpx solid rgba(34, 55, 133, 0.88)"
      ...
      <scroll-view
        class="w-full px-32 py-24 flex flex-col"
        style="
          height: calc(100vh - 379rpx - 140rpx - env(safe-area-inset-bottom));
        "
        scroll-y
