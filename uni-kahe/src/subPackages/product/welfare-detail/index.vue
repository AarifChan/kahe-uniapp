<template>
  <view class="detail w-full bg-main-bg overflow-y-auto px-32 box-border" style="height: calc(100vh - env(safe-area-inset-bottom) - 64rpx);">
    <view style="padding-bottom: 30rpx">
      <view class="detail-top relative w-688 h-688 bg-[#fffbef] rounded-20 flex flex-col items-center justify-center"
      ...
      >
        <image
          ...
          mode="widthFix"
        />
        <view class="detail-top-time absolute z-1 w-225 h-50 flex items-center justify-center text-20 text-black rounded-25" v-if="timeOut"
          style="bottom: 62rpx; background: linear-gradient(180deg, #d8e9fd, #81b2f0); border: 4rpx solid #81b2f0;"
        >
      ...
      <view class="detail-rule relative mt-32 w-full bg-white rounded-20 opacity-97 flex flex-col" style="padding: 16rpx;"
      >
        <Title value="活动规则" />
        <view class="detail-rule-context mt-40 w-full bg-white rounded-20 flex flex-col border-2 border-[#d9d9d9]" style="padding: 16rpx;"
        >
          <view class="detail-rule-context-title mb-8 text-24 text-black font-normal" style="line-height: 30rpx;"></view>
          <view class="detail-rule-context-title mb-8 text-24 text-black font-normal" style="line-height: 30rpx;">
      ...
      <view class="detail-goods relative mt-32 w-full bg-white rounded-20 opacity-97 overflow-y-auto" style="padding: 16rpx 0;"
      >
        <Title value="活动奖励" />
        <view class="detail-goods-item mt-80 w-full grid" style="padding: 0 30rpx 20rpx 30rpx; grid-template-columns: repeat(auto-fill, calc((100% - 18rpx) / 2)); gap: 18rpx;"
        >
          <Item
      ...
      <Rewards
        ...
        :time="timeFinish"
      />
      <view class="detail-recom relative mt-30 w-full h-auto rounded-20 opacity-97" style="padding: 16rpx 0;">
        <Title value="热门推荐" />
        <view class="detail-recom-goods h-auto w-full" style="padding-top: 16rpx;">
      ...
      <view class="detail-bottom fixed left-0 w-750 h-164" style="bottom: 0;">
        ...
        />
        <view class="detail-bottom-content absolute left-0 w-full flex justify-between items-center" style="bottom: 32rpx; padding: 0 30rpx;"
        >
          <view class="detail-bottom-left flex flex-row items-center w-200" style="margin-right: 20rpx; justify-content: space-evenly;"
          >
            <view class="detail-bottom-left-box flex flex-col items-center" style="margin-right: 20rpx; justify-content: space-evenly;" @tap.stop="clickActivity"
            >
              <image
                src="/static/kahe-202510/ka-he/welfare/bottom-item1.png"
                class="detail-bottom-left-box-img w-43 h-40"
              />
              <view class="detail-bottom-left-box-text text-20 text-black"> 活动 </view>
            </view>
            <view class="detail-bottom-left-box flex flex-col items-center" style="margin-right: 20rpx; justify-content: space-evenly;" @tap.stop="clickRewardCode"
            >
              <image
                src="/static/kahe-202510/ka-he/welfare/bottom-item2.png"
                class="detail-bottom-left-box-img2 w-55 h-32"
              />
              <view class="detail-bottom-left-box-text text-20 text-black"> 抽奖码 </view>
            </view>
          </view>
          <view class="detail-bottom-actions flex items-center gap-12">
            <!-- #ifdef MP-WEIXIN -->
            <button class="detail-bottom-share relative w-160 h-76 flex items-center justify-center plain border-none bg-transparent p-0 m-0" open-type="share" plain
            ...
            <!-- #endif -->
            <!-- #ifndef MP-WEIXIN -->
            <view class="detail-bottom-share relative w-160 h-76 flex items-center justify-center" @tap.stop="handleClickShare"
            >
              <image
                class="detail-bottom-share-img w-full h-full"
                src="/static/kahe-202510/ka-he/common/common-btn-bg.png"
            ...
            <view v-else class="detail-bottom-right relative w-181 h-76 flex items-center justify-center" @tap.stop="tapPrizeAction"
            >
              <image
                class="detail-bottom-right-img w-full h-full"
                src="/static/kahe-202510/ka-he/common/common-btn-bg.png"
