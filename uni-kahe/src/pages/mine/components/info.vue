  ...
  <view class="userInfo">
    ...
    <view class="userInfo-center">
      <view class="common-row" @tap.stop="handleLogin">
        ...
        <image class="icon leading-2" src="/static/kaju/mine/edit.png" />
      </view>
      <view class="common-row">
        <view class="userId">UID：{{ userInfo.uid ?? "000000" }}</view>
        <image class="icon leading-2" src="/static/kaju/mine/copy.png" />
      </view>
    ...
    <image
      class="userEdit"
      src="/static/kahe-202510/ka-he/mine/edit.png"
