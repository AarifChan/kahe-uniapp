<template>
    <view class="relative w-full flex flex-row items-center justify-center aspect-ratio-[152/176]">
        ...
        <text class="absolute left-16 w-[calc(100%-32rpx)] font-normal text-24 text-[#FFFFFF] text-center theme-font text-stroke" :style="{ bottom: '8rpx' }">{{item.name}}</text>
...
defineProps({
    ...
    item: {
        ...
        type: Object as PropType<PetModel>
    },
    selected: {
        default: false,
        type: Boolean
